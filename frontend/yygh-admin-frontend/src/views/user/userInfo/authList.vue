    ...
    <el-table
      ...
      <el-table-column label="操作" width="250" align="center">
        <template slot-scope="scope">
          ...
          <el-button style="margin-left: 10px" type="primary" size="mini" @click="approval(scope.row.id, 2)">通过</el-button>
          <el-button style="margin-left: 10px" type="danger" size="mini" @click="approval(scope.row.id, -1)">不通过</el-button>
        </template>
      </el-table-column>
